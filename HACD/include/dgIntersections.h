...
class dgFastRayTest
{
	...
	hacd::HaI32 BoxTestSimd (const dgVector& minBox, const dgVector& maxBox) const;
	...
	hacd::HaF32 PolygonIntersectSimd (const dgVector& normal, const hacd::HaF32* const polygon, hacd::HaI32 strideInBytes, const hacd::HaI32* const indexArray, hacd::HaI32 indexCount) const;
...
/*
hacd::HaF32 dgRayPolygonIntersect (const dgVector& ray_p0, 
								 const dgVector& ray_p1, 
								 const dgVector& normal,
								 const hacd::HaF32* const polygon, 
								 hacd::HaI32 strideInBytes,
								 const hacd::HaI32* const indexArray, 
								 hacd::HaI32 indexCount);

hacd::HaF32 dgRayPolygonIntersectSimd (const dgVector& ray_p0, 
									const dgVector& ray_p1, 
									const dgVector& normal,
									const hacd::HaF32* const polygon, 
									hacd::HaI32 strideInBytes,
...
bool  dgApi dgPointToPolygonDistance (const dgVector& point, const hacd::HaF32* const polygon,  hacd::HaI32 strideInInBytes,   
									  const hacd::HaI32* const indexArray, hacd::HaI32 indexCount, hacd::HaF32 bailOutDistance, dgVector& pointOut);   


/*
hacd::HaI32 dgApi dgConvexPolyhedraToPlaneIntersection (
...
hacd::HaI32 dgApi ConvecxPolygonToConvexPolygonIntersection (
...
hacd::HaI32 dgApi dgConvexIntersection (const dgVector convexPolyA[], hacd::HaI32 countA,
...
//	HACD_ASSERT (q0.m_w == hacd::HaF32 (0.0f));
//	HACD_ASSERT (q1.m_w == hacd::HaF32 (0.0f));
	simd_128 val (((simd_128&)p0 < (simd_128&)q1) & ((simd_128&)p1 > (simd_128&)q0));
	hacd::HaI32 mask = val.GetSignMask();
