...
hacd::HaI32 dgFastRayTest::BoxTestSimd (const dgVector& minBox, const dgVector& maxBox) const
{
...
hacd::HaF32 dgFastRayTest::PolygonIntersectSimd (const dgVector& normal, const hacd::HaF32* const polygon, hacd::HaI32 strideInBytes, const hacd::HaI32* const indexArray, hacd::HaI32 indexCount) const
{
	...
	if ((dist < simd_128(m_dirError)).GetSignMask() & 1) {
		...
		if (test.GetSignMask()) {
			hacd::HaI32 i3 = indexCount - 1; 
			hacd::HaI32 i2 = indexCount - 2; 
			hacd::HaI32 i1 = indexCount - 3; 
			hacd::HaI32 i0 = (indexCount > 3) ? indexCount - 4 : 2; 
			for (hacd::HaI32 i4 = 0; i4 < indexCount; i4 += 4) {
			...
			HACD_ASSERT (ret >= hacd::HaF32 (0.0f));
			HACD_ASSERT (ret <= hacd::HaF32 (1.0f));
			return ret;
		}
	}
...
bool dgApi dgPointToPolygonDistance (const dgVector& p, const hacd::HaF32* const polygon, hacd::HaI32 strideInBytes,
