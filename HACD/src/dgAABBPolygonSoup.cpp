...
class dgAABBTree
{
	...
	void ForAllSectorsSimd (const hacd::HaI32* const indexArray, const hacd::HaF32* const vertexArray, const dgVector& min, const dgVector& max, dgAABBIntersectCallback callback, void* const context) const
	{
		hacd::HaI32 stack;
...
//		const dgAABBTree* const root = this;
	...
	void ForAllSectorsRayHitSimd (const dgFastRayTest& raySrc, const hacd::HaI32* indexArray, const hacd::HaF32* vertexArray, dgRayIntersectCallback callback, void* const context) const
	{
		const dgAABBTree *stackPool[DG_STACK_DEPTH];
